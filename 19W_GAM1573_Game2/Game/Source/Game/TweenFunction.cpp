...
float TweenFunction_Linear(float startValue, float valueRange, double timeElapsed, double totalTime)
{
...
float TweenFunction_SineEaseIn(float startValue, float valueRange, double timeElapsed, double totalTime)
{
    float timeperc = (float)(timeElapsed/totalTime);
    if( timeperc > 1 )
        timeperc = 1;
...
float TweenFunction_SineEaseOut(float startValue, float valueRange, double timeElapsed, double totalTime)
{
    float timeperc = (float)(timeElapsed/totalTime);
    if( timeperc > 1 )
        timeperc = 1;
...
float TweenFunction_SineEaseInOut(float startValue, float valueRange, double timeElapsed, double totalTime)
{
    float timeperc = (float)(timeElapsed/totalTime);
    if( timeperc > 1 )
        timeperc = 1;
...
float TweenFunction_BounceEaseIn(float startValue, float valueRange, double timeElapsed, double totalTime)
{
    return (float)BounceEaseIn( timeElapsed, startValue, valueRange, totalTime );
}

float TweenFunction_BounceEaseOut(float startValue, float valueRange, double timeElapsed, double totalTime)
{
    return (float)BounceEaseOut( timeElapsed, startValue, valueRange, totalTime );
}

float TweenFunction_BounceEaseInOut(float startValue, float valueRange, double timeElapsed, double totalTime)
{
    return (float)BounceEaseInOut( timeElapsed, startValue, valueRange, totalTime );
}

float TweenFunction_ElasticEaseIn(float startValue, float valueRange, double timeElapsed, double totalTime)
{
    return (float)ElasticEaseIn( timeElapsed, startValue, valueRange, totalTime, 3 );
}

float TweenFunction_ElasticEaseOut(float startValue, float valueRange, double timeElapsed, double totalTime)
{
    return (float)ElasticEaseOut( timeElapsed, startValue, valueRange, totalTime, 3 );
}

float TweenFunction_ElasticEaseInOut(float startValue, float valueRange, double timeElapsed, double totalTime)
{
